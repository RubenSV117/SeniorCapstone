...
public class Recipe 
{
    ...
    public Recipe(string name, string imagePath, int calories, int prepTimeMinutes, List<string> tags, List<Ingredient> ingredients, List<string> steps, List<Review> reviews, int starRating, string AuthorID = "", string key = "")
    {
